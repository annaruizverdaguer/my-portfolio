function renderProjects() {
  ...
  element.innerHTML = ``;
  element.innerHTML = `<div class="col-lg-4 mt-5">
          <div class="app-photo">
            <img
          ...
          <div class="justify-content-start app-content">
        ...
        <div class="col-lg-4 mt-5">
          <div class="justify-content-start app-content">
            ...
            <p>
              ...
              </br> </br> Go and check if you need to carry an umbrella!
            </p>
            <form
        ...
        <div class="col-lg-4 mt-5">
          ...
          <div class="justify-content-start app-content">
            ...
            <p>
              ...
              </br> </br> Want to check some users?
            </p>
            <form
